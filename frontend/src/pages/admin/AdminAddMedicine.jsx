      ...
      <header className="flex justify-between items-center px-8 w-full h-16 sticky top-0 z-40 bg-surface border-b border-outline-variant">
        <div className="flex items-center gap-6">
          ...
          <div className="relative">
            ...
            <input className="bg-surface-container-low border-none rounded-lg pl-10 pr-4 py-2 w-72 text-sm focus:ring-2 focus:ring-primary outline-none" placeholder="Search products, orders..." type="text" />
          </div>
        </div>
